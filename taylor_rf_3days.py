...
#    stats = load_obj('Mekong_Basin_data') # observations
    ...
    # for each data set.
    taylor_stats1 = sm.taylor_statistics(df_MI_T3.rfL3ET1*25.4,df_MI_T3.ET1_obs*25.4,'df_MI_T3')
    taylor_stats2 = sm.taylor_statistics(df_MI_T3.rfL3ET2*25.4,df_MI_T3.ET2_obs*25.4,'df_MI_T3')
    taylor_stats3 = sm.taylor_statistics(df_MI_T3.rfL3ET3*25.4,df_MI_T3.ET3_obs*25.4,'df_MI_T3')


    taylor_stats4 = sm.taylor_statistics(df_NB_Ne2.rfL3ET1*25.4,df_NB_Ne2.ET1_obs*25.4,'df_NB_Ne2')
    taylor_stats5 = sm.taylor_statistics(df_NB_Ne2.rfL3ET2*25.4,df_NB_Ne2.ET2_obs*25.4,'df_NB_Ne2')
    taylor_stats6 = sm.taylor_statistics(df_NB_Ne2.rfL3ET3*25.4,df_NB_Ne2.ET3_obs*25.4,'df_NB_Ne2')

    taylor_stats7 = sm.taylor_statistics(df_MN_Ro3.rfL3ET1*25.4,df_MN_Ro3.ET1_obs*25.4,'df_MN_Ro3')
    taylor_stats8 = sm.taylor_statistics(df_MN_Ro3.rfL3ET2*25.4,df_MN_Ro3.ET2_obs*25.4,'df_MN_Ro3')
    taylor_stats9 = sm.taylor_statistics(df_MN_Ro3.rfL3ET3*25.4,df_MN_Ro3.ET3_obs*25.4,'df_MN_Ro3')

    taylor_stats10 = sm.taylor_statistics(df_IA_Br1.rfL3ET1*25.4,df_IA_Br1.ET1_obs*25.4,'df_IA_Br1')
    taylor_stats11 = sm.taylor_statistics(df_IA_Br1.rfL3ET2*25.4,df_IA_Br1.ET2_obs*25.4,'df_IA_Br1')
    taylor_stats12 = sm.taylor_statistics(df_IA_Br1.rfL3ET3*25.4,df_IA_Br1.ET3_obs*25.4,'df_IA_Br1')

    taylor_stats13 = sm.taylor_statistics(df_WI_CS.rfL3ET1*25.4,df_WI_CS.ET1_obs*25.4,'df_WI_CS')
    taylor_stats14 = sm.taylor_statistics(df_WI_CS.rfL3ET2*25.4,df_WI_CS.ET2_obs*25.4,'df_WI_CS')
    taylor_stats15 = sm.taylor_statistics(df_WI_CS.rfL3ET3*25.4,df_WI_CS.ET3_obs*25.4,'df_WI_CS')

    taylor_stats16 = sm.taylor_statistics(df_MN_Ro1.rfL3ET1*25.4,df_MN_Ro1.ET1_obs*25.4,'df_MN_Ro1')
    taylor_stats17 = sm.taylor_statistics(df_MN_Ro1.rfL3ET2*25.4,df_MN_Ro1.ET2_obs*25.4,'df_MN_Ro1')
    taylor_stats18 = sm.taylor_statistics(df_MN_Ro1.rfL3ET3*25.4,df_MN_Ro1.ET3_obs*25.4,'df_MN_Ro1')

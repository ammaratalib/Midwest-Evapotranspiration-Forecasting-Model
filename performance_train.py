...
y1=(df["train_obs16"][(df['soil']=='sandy loam')])*25.4
x1= (df["rnntrain_pred16"][(df['soil']=='sandy loam')])*25.4

y2=(df["train_obs16"][(df['soil']=='silt loam')])*25.4
x2= (df["rnntrain_pred16"][(df['soil']=='silt loam')])*25.4
y3=(df["train_obs16"][(df['soil']=='loam')])*25.4
x3=(df["rnntrain_pred16"][(df['soil']=='loam')])*25.4
...
obs=df.rftrain_obs16
pre=df.rftrain_pred16
...
df["resid1"]=(df.rftest_pred16-df.test_obs16)*25.4
df["resid2"]=(df.rftest_pred11-df.test_obs16)*25.4
...
ax.legend([bp1["boxes"][0], bp2["boxes"][0]], ['rf_16', 'rf_11'], loc='upper left',prop={'size': 8})
